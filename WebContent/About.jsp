...
<body><img src="assets/img/MedeliveryLogo.png">
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav">
                    ...
                    <c:choose>
	                	...
	                	<c:otherwise>
			                <ul class="nav navbar-nav ml-auto">
			                    s<li class="nav-item" role="presentation"><a class="nav-link" href="Login.jsp">Login</a></li>
    ...
    <div class="col">
        <h1 class="text-center" style="font-size:29px;font-family:Lora, serif;margin:40px;">About Us</h1>
    </div>
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div><img src="assets/img/WORKING_PHARMA.jpg" style="max-width:100%;height:auto;" /></div>
                </div>
                <div class="col-md-6">
                    <div>
    ...
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div>
                        <h1 class="text-center" style="font-family:Lora, serif;">Our Vision</h1>
                        <p class="text-center" style="font-family:Lora, serif;"><br><br><em>We hope that our system will be allied with a multitude of established pharmacies</em><br><em>and delivery services that ensure a long-term partnership of delivering the fastest and</em><br><em>most efficient list of products in the near future.</em><br><br><br><br></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div><img class="img-fluid d-inline d-sm-flex m-auto" src="assets/img/WORKING_PROGRAM.jpg" style="width:415PX;margin:30px;padding:2px;"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div><img src="assets/img/dELIVERY_GUY.jpg" class="center" style=" max-width:100%; height:auto;"  /></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row people">
                <div class="col-md-6 col-lg-4 item">
                    <div class="box">
                        <h3 class="name">Albert Calvelo</h3>
                ...
                <div class="col-md-6 col-lg-4 item">
                    <div class="box">
                        <h3 class="name">Kyrie Fajardo</h3>
                ...
                <div class="col-md-6 col-lg-4 item">
                    <div class="box">
                        <h3 class="name">Skye Trinidad</h3>
                        <p class="title">FRONT-END DEVELOPER</p>
                        <p class="description">Aenean tortor est, vulputate quis leo in, vehicula rhoncus lacus. Praesent aliquam in tellus eu gravida. Aliquam varius finibus est, et interdum justo suscipit id. Etiam dictum feugiat tellus, a semper massa. </p>
                        <div class="social"><a href="#"><i class="fa fa-facebook-official"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-instagram"></i></a></div>
                    </div>
