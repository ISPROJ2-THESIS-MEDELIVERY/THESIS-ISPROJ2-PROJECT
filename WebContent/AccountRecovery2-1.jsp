...
<body><img src="/MedeliveryLogo.png">
    ...
    <div class="col" style="height:217px;padding:6px;">
        <h1 class="text-center" style="font-size:33px;padding:14px;">A confirmation link has been sent to your Email Address</h1>
    </div>
    ...
    <script id="bs-live-reload" data-sseport="3074" data-lastchange="1519443466790" src="/js/livereload.js"></script>
</body>
