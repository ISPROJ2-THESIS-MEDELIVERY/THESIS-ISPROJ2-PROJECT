    ...
    <div>
                            ...
                            <tbody>
                              	<c:forEach items="${productList}" var="item">
										<tr>
											...
											<td><img src="images/Product${item.productID}.jpg" height="250px" width="250px"><a href="images/Product${item.productID}.jpg">Download</a></td>
        ...
        <div id="cid_14" class="form-input-wide alert alert-info"  role="alert">
          <div id="text_14" class="form-html" data-component="text">
            <p><em>NOTE: Prescription is <span style="color: #ff0000;"><strong>required</strong></span> to purchase a new medicine that is not presented in the shop</em></p>
          <br>
