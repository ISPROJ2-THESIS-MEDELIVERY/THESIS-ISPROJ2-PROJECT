...
<body><img src="/MedeliveryLogo.png">
        ...
        <div class="container-fluid"><a class="navbar-brand" href="#"></a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="Catalog.html">View Products</a></li>
                </ul>
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item" role="presentation"><a class="nav-link" href="Login.html">Login</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="Home.html">Log Out</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <form method="post" style="padding:56px;margin:-21px;height:470px;">
        <h2 class="sr-only">Login Form</h2>
        <div class="illustration"></div>
        <div class="form-group"><input class="form-control" type="email" name="email" required="" placeholder="Email" maxlength="100" style="width:263px;padding:0px;height:42px;"></div>
        <div class="form-group"><input class="form-control" type="password" name="password" required="" placeholder="Password" maxlength="100" style="padding:0px;width:264px;height:42px;"></div>
        <div class="form-group"><a class="btn btn-primary btn-block" role="button" href="" style="width:266px;background-color:#465765;">Log In</a></div>
        <p style="font-size:13px;">Don't have an account yet? Register <a href="Members.html">here</a></p>
        <p style="font-size:13px;"><a href="AccountRecovery.html">Forgot password?</a></p>
    </form>
    ...
    <script id="bs-live-reload" data-sseport="3074" data-lastchange="1519444964264" src="/js/livereload.js"></script>
</body>
