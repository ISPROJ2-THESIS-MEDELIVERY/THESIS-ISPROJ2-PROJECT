...
<body><img src="/MedeliveryLogo.png">
        ...
        <div class="container-fluid"><a class="navbar-brand" href="#"></a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="ViewOrderStatus.html">View Products</a></li>
                </ul>
    ...
    <script id="bs-live-reload" data-sseport="3074" data-lastchange="1519443917319" src="/js/livereload.js"></script>
</body>
