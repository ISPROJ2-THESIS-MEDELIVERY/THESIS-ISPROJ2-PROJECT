	...
	<h2>Add a New Courier Service</h2><br>
        ...
        <div class="form-group">
			...
			<c:forEach items="${CityList}" var="city">
				<option value =<c:out value="${city.cityName}"/>><c:out value="${city.cityName}" /></option>
			</c:forEach>
		  </select>
        </div>     
        <div class="form-group">
        ...
        <div class="form-group">
        	<input id="phonenum" type="tel" pattern="^(09|\+639)\d{9}$" title="must start with 09 and contain 11 digits" name="CompCell" required="required" placeholder="Courier Cellphone" class="form-control"/>
        </div>          
        <div class="form-group">
